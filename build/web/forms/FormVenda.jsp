...
<%@page import="application.Venda, application.Cliente, application.Produto, application.Funcionario, java.lang.String, java.lang.Integer, java.util.ArrayList, java.util.Date" %>
        ...
        <div class="forms">
            ...
            <div>
                <form method="POST" action="VendaController" name="cad-venda" id="cad-venda">
                    ...
                    <div class="mb-4">
                        <label for="funcionario-venda" class="form-label">Funcionário:</label>
                        <select class="form-control" id="funcionario-venda" name="id_funcionario" required>
